...
:: Android packaging
set AND_CERT_NAME="SportzPicksGame"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SportzPicksGame.p12
...
set IOS_PROVISION=cert\SportzPicksGame.mobileprovision
...
set APP_ID=air.SportzPicksGame

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SportzPicksGame
